...
/*-------------------------------------------------------------
 * Packing as a module by Ace, 2017,5,19
 * 
 * 1. Change each keyword 'var' to 'let'
 * 2. Change each function from:
 *          function foo(argvs) {...}
 *    to:
...
/*-------------------------------------------------------------
 * The parts of below are moved into module.exports bye Ace.
 *-------------------------------------------------------------
 */
 ...
 */
let rstr_hmac_md5 = function(key, data)
{
 ...
 */
let rstr2any = function(input, encoding)
{
 ...
 */
let str2rstr_utf8 = function(input)
{
  let output = "";
  let i = -1;
  let x, y;
 ...
 */
let str2rstr_utf16le = function(input)
{
  let output = "";
  for(let i = 0; i < input.length; i++)
...
let str2rstr_utf16be = function(input)
{
  let output = "";
  for(let i = 0; i < input.length; i++)
